...
const review = () => {
    return (
        <div>
            ...
            <div>
                <div>
                    <h1 className="secondary-title text-4xl font-bold mb-8 text-center text-red-600">Customer Reviews</h1>
                </div>
                <div className='grid lg:grid-cols-3 md:grid-cols-2 sm:grid-cols-1 gap-5 p-5'>
                    <div className="flex justify-center">
                        <div className="block rounded-lg shadow-lg bg-red-100 hover:bg-red-200 max-w-sm ">
                            <div className="py-3 px-6 border-b border-red-300">
